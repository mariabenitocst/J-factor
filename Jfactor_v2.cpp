...
double smax = 400.;
double alpha, rs, rho0;
/************************************
		R8v214
************************************/

/* AiX */ //alpha = 0.998;   rs = 37.510; rho0 = 0.250;   
/* AjX */ //alpha = 1.036;  rs = 10.002;  rho0 = 0.318;   
/* AkX */ //alpha = 1.999;  rs = 34.694;   rho0 = 0.100;  
/* AlX */ alpha = 1.181;  rs = 10.001;  rho0 = 0.288;   
/* AmX */ //alpha = 1.147;  rs = 10.005;  rho0 = 0.261; 
/* BiX */ //alpha = 0.748;  rs = 19.621;  rho0 = 0.250;   
/* BjX */ //alpha = 1.001;  rs = 10.002;  rho0 = 0.318;   
/* BkX */ //alpha = 1.999;  rs = 44.345;  rho0 = 1.000;   
/* BlX */ //alpha = 1.147;  rs = 10.001;  rho0 = 0.288;  
/* AmX */ //alpha = 1.110;  rs = 10.002;  rho0 = 0.261;   
/* CiX */ //alpha = 0.241;  rs = 10.030;  rho0 = 0.252;   &     &     &   \\
/* CjX */ //alpha = 0.874;  rs = 10.004;  rho0 =  0.322;   &     &     &   \\
/* CkX */ //alpha = 1.999;  rs = 51.751;  rho0 =  0.100;   &     &     &   \\
/* ClX */ //alpha = 1.008;  rs = 10.001;  rho0 =  0.293;   &     &     &   \\
/* CmX */ //alpha = 0.857;  rs = 10.000;  rho0 =  0.269;   &     &     &   \\

/* DiX */ //alpha = 0.001;  rs = 11.112;  rho0 =  0.257;   &     &     &   \\
/* DjX */ //alpha = 0.906;  rs = 10.001;  rho0 = 0.321;   &     &     &   \\
/* DkX */ //alpha = 1.932;  rs = 98.781;  rho0 =  0.100;   &     &     &   \\
/* DlX */ //alpha = 1.051;  rs = 10.010;  rho0 =  0.291;   &     &     &   \\
/* DmX */ //alpha = 0.989;  rs = 10.010;  rho0 =  0.264;   &     &     &   \\

/* EiX */ //alpha = 0.970;  rs = 28.673;  rho0 =  0.250;   &     &     &   \\
/* EjX */ //alpha = 1.066;  rs = 10.001;  rho0 =  0.323;   &     &     &   \\
/* EkX */ //alpha = 2.000;  rs = 31.453;  rho0 =  0.100;   &     &     &   \\
/* ElX */ //alpha = 1.210;  rs = 10.006;  rho0 =  0.292;   &     &     &   \\
/* EmX */ //alpha = 1.179;  rs = 10.009;  rho0 =  0.265;   &     &     &   \\

/* FiX */ //alpha = 1.241;  rs = 99.877;  rho0 =  0.247;   &     &     &   \\
/* FjX */ //alpha = 1.218;  rs = 10.000;  rho0 =  0.314;  // &     &     &   \\
/* FkX */ //alpha = 2.000;  rs = 27.301;  rho0 =  0.100; //  &     &     &   \\
/* FlX */ //alpha = 1.373;  rs = 10.003;  rho0 =  0.282;  // &     &     &   \\
/* FmX */ //alpha = 1.366;  rs = 10.004;  rho0 =  0.253; //  &     &     &   \\
...
/* FjX */ //double alpha = 1.031; double rs = 10.104; double rho0 = 0.442;
/* FkX */ //double alpha = 1.817; double rs = 99.611; double rho0 = 0.205;
/* FlX */ //double alpha = 1.139; double rs = 10.006; double rho0 = 0.415;
/* FmX */ //double alpha = 1.103; double rs = 10.010; double rho0 = 0.387;
